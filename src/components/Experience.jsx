...
const Experience = () => {
  ...
  return (
    ...
    >
      <div className="max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full pt-40 text-white">
        <div>
        ...
        <div className="w-full grid grid-cols-2 sm:px-0 sm:grid-cols-3 gap-8 text-center py-8 px-12 ">
